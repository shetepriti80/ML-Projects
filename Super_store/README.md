...
3. Performs the required feature encoding.
4. Aligns the input features with the trained model.
5. Passes the data to the KNN Regression model.
6. Displays the predicted sales value.
...
This project demonstrates how a complete Machine Learning system can be developed using **K-Nearest Neighbors Regression** and deployed as a web application using **Flask**. It provides a practical example of converting a trained Machine Learning model into an interactive application capable of generating real-time sales predictions.
